...
const byte LEDforCT2 = 8; // <-- the "mode" port is active-high
...
//
const float powerCal_forCT1 = 0.0446;  // for CT1   3rd Feb 2024
const float powerCal_forCT2 = 0.0416;  // for CT2  3rd Feb 2024
